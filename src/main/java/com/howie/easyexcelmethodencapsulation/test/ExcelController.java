...
import com.howie.easyexcelmethodencapsulation.excel.LackInfo;
...
public class ExcelController {
    ...
    public Object readExcelWithSheets(MultipartFile excel) {
        return ExcelUtil.readExcel(excel, new LackInfo());
    }
    ...
    public Object readExcel(MultipartFile excel, @RequestParam(value = "sheetNo",required = false)int sheetNo,
                            @RequestParam(defaultValue = "1") int headLineNum) {
        return ExcelUtil.readExcel(excel, new LackInfo(), 1, 2);
    }
